...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Alphaden Technologies</title>
     ...
     <div>
      ...
      <div className='d-flex justify-content-center'>
        ...
        <div className='row mx-auto'>
          ...
          <div>
            <p className={styles.serviceparagraphs}>Let your users get in touch with delivery executive for any kind of queries related to their pickup and delivery orders</p>
          </div>
        </div>
          </div>
          <div className={`$ col-12 col-md-6 col-lg-4`}>
